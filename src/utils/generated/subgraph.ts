...
export type TokenQuery = { readonly __typename?: "Query" } & {
  readonly token?: Maybe<
    { readonly __typename?: "Token" } & Pick<Token, "id" | "name" | "symbol" | "derivedETH">
  >;
};
...
export type BundleQuery = { readonly __typename?: "Query" } & {
  readonly bundle?: Maybe<{ readonly __typename?: "Bundle" } & Pick<Bundle, "id" | "ethPrice">>;
};

export type BundlesQueryVariables = Exact<{ [key: string]: never }>;

export type BundlesQuery = { readonly __typename?: "Query" } & {
  readonly bundles: ReadonlyArray<
    { readonly __typename?: "Bundle" } & Pick<Bundle, "id" | "ethPrice">
  >;
};

export type TokenInfoFragment = { readonly __typename?: "Token" } & Pick<
  Token,
  "id" | "name" | "symbol" | "derivedETH"
>;
